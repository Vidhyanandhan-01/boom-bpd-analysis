...
// ---------------------
// Branch Predictor Comparison Configs
// All use SmallBoom (1-wide, 32-entry ROB) core — only BPD changes.
// TAGE-L:   full TAGE + loop predictor (state-of-the-art, default)
// GShare:   single-table TAGE with global history (mid-complexity)
// BIM:      bimodal 2-bit saturating counters (simplest baseline)
// ---------------------

class BoomTAGELBPDConfig extends Config(
  new boom.v3.common.WithTAGELBPD ++
  new boom.v3.common.WithNSmallBooms(1) ++
  new chipyard.config.AbstractConfig)

class BoomGShareBPDConfig extends Config(
  new boom.v3.common.WithBoom2BPD ++
  new boom.v3.common.WithNSmallBooms(1) ++
  new chipyard.config.AbstractConfig)

class BoomBIMBPDConfig extends Config(
  new boom.v3.common.WithAlpha21264BPD ++
  new boom.v3.common.WithNSmallBooms(1) ++
  new chipyard.config.AbstractConfig)
